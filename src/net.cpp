...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Citicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"citicointools.com", "209.97.132.158"},
    {"citicoinpool.org", "209.97.132.166"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"citicointools.com", "209.97.132.176"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Citicoin is probably already running."), addrBind.ToString().c_str());
        else
